<%@ Page Title="" Language="C#" MasterPageFile="~/Supplier/SupplierSite.master" AutoEventWireup="true" CodeFile="SuppAdvance.aspx.cs" Inherits="Supplier_SuppAdvance" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:1000px;margin:auto">
<h2 class="head">Supplier Advance Status</h2>
        <p>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT * FROM [SuppAdvView] WHERE ([SupplId] = @SupplId)">
                <SelectParameters>
