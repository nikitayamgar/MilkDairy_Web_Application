...
public partial class BuffelowRateEntry : System.Web.UI.Page
{
    ...
    {
        db.ExecuteCommand("Delete from BuffelowMilkRate");
        ...
        while (a <= b)
        {
            db.ExecuteCommand("Insert into BuffelowMilkRate (Fat,MilkRate) Values(" + a + "," + r + ")");
            a = a + 0.1;
            r = r + i;
        }

        ClientScript.RegisterStartupScript(GetType(), "a1", "alert('Buffelow Milk Rate Updated')", true);
