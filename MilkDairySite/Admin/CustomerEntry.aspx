<%@ Page UnobtrusiveValidationMode="None" Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.master" AutoEventWireup="true"
    CodeFile="CustomerEntry.aspx.cs" Inherits="CustomerEntry" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="SaveButton" runat="server" Text="Submit" Width="93px" OnClick="SaveButton_Click"
                                Height="33px" />
                            &nbsp;<asp:Button ID="SaveButton0" runat="server" Text="Customer List" Width="135px"
                                Height="33px" PostBackUrl="~/Admin/Customers.aspx" CausesValidation="False" />
                            </td>
                    </tr>
                </table>
                <br />
