<%@ Page UnobtrusiveValidationMode="None" Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.master" AutoEventWireup="true"
    CodeFile="SupplierEntry.aspx.cs" Inherits="SupplierEntry" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="SaveButton" runat="server" Text="Submit" Width="93px" OnClick="SaveButton_Click"
                                Height="33px" />
                            &nbsp;<asp:Button ID="SaveButton0" runat="server" Text="Supplier List" Width="151px"
                                Height="33px" CausesValidation="False" PostBackUrl="~/Admin/Suppliers.aspx" />
                            </td>
                    </tr>
                </table>
                <br />
