<%@ Page UnobtrusiveValidationMode="None" Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.master" AutoEventWireup="true" CodeFile="CowRateEntry.aspx.cs" Inherits="CowRateEntry" %>
...
&nbsp;<asp:Button ID="CancelButton" runat="server" Text="Cancel" onclick="CancelButton_Click" CausesValidation="False" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [CowMilkRate] ORDER BY [Fat]" 
        DeleteCommand="DELETE FROM [CowMilkRate] WHERE [Id] = @Id" 
        InsertCommand="INSERT INTO [CowMilkRate] ([Fat], [MilkRate]) VALUES (@Fat, @MilkRate)" 
        UpdateCommand="UPDATE [CowMilkRate] SET [Fat] = @Fat, [MilkRate] = @MilkRate WHERE [Id] = @Id">
        <DeleteParameters>
