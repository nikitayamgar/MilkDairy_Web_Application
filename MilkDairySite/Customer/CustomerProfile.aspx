<%@ Page UnobtrusiveValidationMode="None" Title="" Language="C#" MasterPageFile="~/Customer/CustomerSite.master" AutoEventWireup="true"
    CodeFile="CustomerProfile.aspx.cs" Inherits="CustomerProfile" %>
                ...
                <table class="style1">
                    ...
                    <tr>
                        <td class="auto-style2">
                            UserName</td>
                        <td>
                            <asp:TextBox ID="UserTextBox" runat="server" Width="300px" ReadOnly="True"></asp:TextBox>
                    ...
                    <tr>
                        <td class="auto-style2">
                            Password</td>
                        <td>
                            <asp:TextBox ID="PasswordTextBox" runat="server" Width="300px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="SaveButton" runat="server" Text="Update" Width="93px" OnClick="SaveButton_Click"
                                Height="33px" />
                            &nbsp;</td>
                    </tr>
                </table>
